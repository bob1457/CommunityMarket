...
namespace CommonMarket.Web.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        public ActionResult Index(ManageMessageId? message)
        {
            ...
            //Get user account information, e.g. user id, and find an entry in supplier table to check if the account is active or not. 
            //if not active, or ther eis no entry at all, display a page stating the status
            
            //var currentUser = UserManager.FindById(User.Identity.GetUserId());


            //var supplier =
            //    //_services.GetAllSuppliers().FirstOrDefault(p => p.UserProfileId == currentUser.UserProfile.Id);
            //    _supplierRepository.GetAll().FirstOrDefault(p => p.UserProfileId == currentUser.UserProfile.Id);
        ...
        //Old Implementation -- Will NOT be reqiured

        #region Old Implementation -- Will NOT be reqiured
        //
